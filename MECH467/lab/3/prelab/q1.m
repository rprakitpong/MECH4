...
subplot(3,1,1);
plot(data(:,1), data(:,2));
title('A2: displacement (mm) over time (s)');
subplot(3,1,2);
plot(data(:,1), data(:,3));
title('A2: feedrate (mm/s) over time (s)');
subplot(3,1,3);
plot(data(:,1), data(:,4));
title('A2: tangential acceleration (mm/s/s) over time (s)');
saveas(gcf, 'qA2.png');
clf;
...
plot(data(:,1), data(:,5));
plot(data(:,1), data(:,6));
title('A3: axis position (mm) over time (s)');
legend('x', 'y');
subplot(3,1,2);
hold on;
plot(data(:,1), data(:,7));
plot(data(:,1), data(:,8));
title('A2: axis velocity (mm/s) over time (s)');
legend('x', 'y');
subplot(3,1,3);
hold on;
plot(data(:,1), data(:,9));
plot(data(:,1), data(:,10));
title('A2: axis acceleration (mm/s/s) over time (s)');
legend('x', 'y');
saveas(gcf, 'qA3.png');
clf;
